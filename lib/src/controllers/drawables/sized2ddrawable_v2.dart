...
abstract class Sized2DDrawableV2 extends ObjectDrawable {
  /// The size of the drawable.
  final Size size;

  /// Creates a new [Sized2DDrawableV2] with the given [size] and [painting].
  const Sized2DDrawableV2({
    required this.size,
